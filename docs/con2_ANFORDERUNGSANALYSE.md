...
| Regression | Python- und PWA-Smokes ohne OneDrive-Mutation | ERFÜLLT | 37 Pytest-Tests, Source-Smoke Exit 0, 32 Node-Tests |
| Vollständige GUI-Abnahme | Tk/ttk-Runtime, visuelle Prüfung und Screenreader | TEILWEISE | Zwei erwartete Tkinter-Skips auf diesem Host; kein Screenreader-Claim |

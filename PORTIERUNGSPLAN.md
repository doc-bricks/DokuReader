...
|---|---|---|
| Windows/Tkinter | autoritative Desktop-App, lokale JSON-State-Datei, Vorschau und PDF-Export | lokale Python-/Source-Smokes grün |
...
2. A11y-Metadaten, Zustände, Tastatur-/Fokuspfade und erklärende Leer-/Fehler-
   texte prüfen; erst danach visuelle Detailpolitur bewerten.
...
- kein Push, kein Tag, kein GitHub-Release und kein Store-Upload;
